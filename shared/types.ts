/**
 * Shared Types - Universal Rack Case Schema
 *
 ...
 *
 * Used by both the pipeline and website.
 * Runtime validation is handled by Zod schemas in pipeline/src/schema/validators.ts
 *
 * NOTE: These TypeScript types are kept in sync with the Zod schemas.
